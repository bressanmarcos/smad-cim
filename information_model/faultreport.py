...
#
# Command line:
#   /usr/local/bin/generateDS -o "./information_model/faultreport.py" --export="write etree validate generator" -q -f --silence ./artifacts/faultreport.xsd
#
...
class Breaker_DiscreteMeasAlias3(Enum):
    FALSE='False'
    TRUE='True'
    INVALID='Invalid'
    OPEN='Open'
...
class Breaker_DiscreteValue_Integer1(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Breaker_DiscreteValue_Integer1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Breaker_DiscreteValue_Integer1.subclass:
            return Breaker_DiscreteValue_Integer1.subclass(*args_, **kwargs_)
        else:
            return Breaker_DiscreteValue_Integer1(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:smad="grei.ufc.br/smad"', name_='Breaker_DiscreteValue_Integer1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Breaker_DiscreteValue_Integer1')
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Breaker_DiscreteValue_Integer1')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Breaker_DiscreteValue_Integer1', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Breaker_DiscreteValue_Integer1'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:smad="grei.ufc.br/smad"', name_='Breaker_DiscreteValue_Integer1', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Breaker_DiscreteValue_Integer1', mapping_=None):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class Breaker_DiscreteValue_Integer1
...
class Power_Analog(GeneratedsSuper):
    ...
    def __init__(self, name=None, unitMultiplier=None, unitSymbol=None, AnalogValues=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.name = name
        self.validate_Analog_Meas2(self.name)
        self.name_nsprefix_ = None
        self.unitMultiplier = unitMultiplier
        self.validate_UnitMultiplier10(self.unitMultiplier)
        self.unitMultiplier_nsprefix_ = None
        self.unitSymbol = unitSymbol
        self.validate_UnitSymbol11(self.unitSymbol)
    ...
    def set_AnalogValues(self, AnalogValues):
        self.AnalogValues = AnalogValues
    def validate_Analog_Meas2(self, value):
        result = True
        # Validate type Analog_Meas2, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on Analog_Meas2' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_UnitMultiplier10(self, value):
        result = True
        # Validate type UnitMultiplier10, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on UnitMultiplier10' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_UnitSymbol11(self, value):
        result = True
        # Validate type UnitSymbol11, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on UnitSymbol11' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        # validate simple type attributes
        # validate simple type children
        self.gds_validate_defined_ST_(self.validate_Analog_Meas2, self.name, 'name')
        self.gds_check_cardinality_(self.name, 'name', min_occurs=1, max_occurs=1)
        self.gds_validate_defined_ST_(self.validate_UnitMultiplier10, self.unitMultiplier, 'unitMultiplier')
        self.gds_check_cardinality_(self.unitMultiplier, 'unitMultiplier', min_occurs=0, max_occurs=1)
        self.gds_validate_defined_ST_(self.validate_UnitSymbol11, self.unitSymbol, 'unitSymbol')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'name':
            ...
            # validate type UnitMultiplier10
            self.validate_UnitMultiplier10(self.unitMultiplier)
...
class ReportingGroup_Type(GeneratedsSuper):
    ...
    def to_etree(self, parent_element=None, name_='ReportingGroup_Type', mapping_=None):
        ...
        if self.description is not None:
            ...
            etree_.SubElement(element, '{grei.ufc.br/smad}description').text = self.gds_format_string(description_)
        for Isolated_EnergyConnection_ in self.Isolated_EnergyConnection:
            Isolated_EnergyConnection_.to_etree(element, name_='Isolated_EnergyConnection', mapping_=mapping_)
        for Deenergized_EnergyConnection_ in self.Deenergized_EnergyConnection:
            Deenergized_EnergyConnection_.to_etree(element, name_='Deenergized_EnergyConnection', mapping_=mapping_)
        for Feeder_ in self.Feeder:
        ...
        for Isolated_ControlArea_ in self.Isolated_ControlArea:
            Isolated_ControlArea_.to_etree(element, name_='Isolated_ControlArea', mapping_=mapping_)
        for Deenergized_ControlArea_ in self.Deenergized_ControlArea:
            Deenergized_ControlArea_.to_etree(element, name_='Deenergized_ControlArea', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        return element
    def validate_(self, gds_collector, recursive=False):
...
class SwitchAction(GeneratedsSuper):
    ...
    def __init__(self, kind=None, executedDateTime=None, SwitchingPlan=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.kind = kind
        self.validate_SwitchActionKind9(self.kind)
    ...
    def set_SwitchingPlan(self, SwitchingPlan):
        self.SwitchingPlan = SwitchingPlan
    def validate_SwitchActionKind9(self, value):
        result = True
        # Validate type SwitchActionKind9, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on SwitchActionKind9' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        # validate simple type attributes
        # validate simple type children
        self.gds_validate_defined_ST_(self.validate_SwitchActionKind9, self.kind, 'kind')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'kind':
            ...
            # validate type SwitchActionKind9
            self.validate_SwitchActionKind9(self.kind)
...
class SwitchingPlan(GeneratedsSuper):
    ...
    def __init__(self, mRID=None, purpose=None, gds_collector_=None, **kwargs_):
        ...
        self.validate_Purpose7(self.purpose)
    ...
    def set_purpose(self, purpose):
        self.purpose = purpose
    def validate_Purpose7(self, value):
        result = True
        # Validate type Purpose7, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on Purpose7' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.mRID, 'mRID')
        self.gds_check_cardinality_(self.mRID, 'mRID', min_occurs=1, max_occurs=1)
        self.gds_validate_defined_ST_(self.validate_Purpose7, self.purpose, 'purpose')
...
RenameMappings_ = {
    "{grei.ufc.br/smad}Analog_Meas": "Analog_Meas2",
    "{grei.ufc.br/smad}Breaker_DiscreteMeasAlias": "Breaker_DiscreteMeasAlias3",
    "{grei.ufc.br/smad}Breaker_DiscreteValue_Integer": "Breaker_DiscreteValue_Integer1",
    "{grei.ufc.br/smad}Breaker_DiscreteValue_Integer_value": "Breaker_DiscreteValue_Integer_value4",
    "{grei.ufc.br/smad}Discrete_Meas": "Discrete_Meas5",
    "{grei.ufc.br/smad}PhaseCode": "PhaseCode6",
    "{grei.ufc.br/smad}Purpose": "Purpose7",
    "{grei.ufc.br/smad}ReportName": "ReportName8",
    "{grei.ufc.br/smad}SwitchActionKind": "SwitchActionKind9",
    "{grei.ufc.br/smad}UnitMultiplier": "UnitMultiplier10",
    "{grei.ufc.br/smad}UnitSymbol": "UnitSymbol11",
}

__all__ = [
    "Boolean",
    "Breaker_DiscreteValue_Integer",
    "Breaker_DiscreteValue_Integer1",
    "ControlArea",
    "DateTime",
    "EnergyConnection",
    "Feeder",
