...
#
# Generated Tue Jun 30 22:27:44 2020 by generateDS.py version 2.35.24.
...
class SwitchAction(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, kind=None, isFreeSequence=None, sequenceNumber=None, executedDateTime=None, issuedDateTime=None, plannedDateTime=None, OperatedSwitch=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
