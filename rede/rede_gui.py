...
if __name__ == "__main__":
    ...
    # Instancia rede
    network = Network('./rede/models/rede-cim-2.xml')
    ...
    # Chaves
    switch_buttons = {}
    for index, chave in enumerate(sorted(network.chaves.values(), key=lambda chave: str2int(chave.nome))):
